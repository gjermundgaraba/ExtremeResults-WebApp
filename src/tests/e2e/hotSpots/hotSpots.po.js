...
var HotSpotsPage = function () {
    this.createHotSpotBucketInput = element(by.model('vm.hotSpotBucketName'));
    ...
    this.hotSpotBucketEditButton = function (index) {
        return this.hotSpotBuckets.get(index).element(by.css('[ng-click="vm.editHotSpotBucket(hotSpotBucket)"]'));
    };
    ...
    this.hotSpotBuckets = element.all(by.repeater('hotSpotBucket in vm.hotSpotBuckets'));
};
